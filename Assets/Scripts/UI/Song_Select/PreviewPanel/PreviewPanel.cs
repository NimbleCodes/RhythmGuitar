...
public class PreviewPanel : MonoBehaviour
{
    ...
    GameObject PlayBtn, ExtraBtn;
    RectTransform PlayBtnRt, ExtraBtnRt;
    ...
    void Awake(){
        ...
        ExtraBtn = rt.Find("ExtraBtn").gameObject;
        PlayBtnRt = PlayBtn.GetComponent<RectTransform>();
        ExtraBtnRt = ExtraBtn.GetComponent<RectTransform>();
        PlayBtnRt.localPosition = new Vector3(-(rt.rect.width - PlayBtnRt.rect.width), -rt.rect.height * 0.25f, 0);
        ExtraBtnRt.localPosition = new Vector3(rt.rect.width - PlayBtnRt.rect.width, -rt.rect.height * 0.4f, 0);
